			...
			<div class="collapse navbar-collapse" id="navcol-1">
				...
				<ul class="nav navbar-nav">
					<c:choose>
						<c:when test="${sessionScope.roleId == '0' }">
							...
							<li class="nav-item" role="presentation"><a class="nav-link"
								href="${pageContext.request.contextPath}/booking/list">QuickBooking
									List</a></li>
							<li class="nav-item" role="presentation"><a class="nav-link"
								href="${pageContext.request.contextPath}/booking/cancellist">BookingCancel</a></li>
				...
				<span class="navbar-text"> <a
					href="${pageContext.request.contextPath}/login" class="login">
						LogIn </a>
				</span> <a style="color: blue" "class="signup"
				...
				<a href="${pageContext.request.contextPath}/admin/profile">Welcome ${memberName}
